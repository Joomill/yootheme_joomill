...
// ADDED CANONICAL URL CODE
$canonical = \Joomla\CMS\Uri\Uri::getInstance()->toString();
...
<html lang="<?= $this->language ?>" dir="<?= $this->direction ?>" vocab="https://schema.org/">
    <head>
        ...
        <?php // ADDED THEME-COLOR ?>
        <meta name="theme-color" content="<?= $config('~theme.less.@button-default-background') ?>"/>
        <link rel="shortcut icon" href="<?= $config('~theme.favicon') ?>">
        <link rel="apple-touch-icon" href="<?= $config('~theme.touchicon') ?>">
        <?php // ADDED CANONICAL URL ?>
